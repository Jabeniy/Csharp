        ...
        static void Main(string[] args)
        {
            ...
            while (!sr.EndOfStream)
            {
                try
                {
                    ...
                    {
                        if (courseFrequency.ContainsKey(int.Parse(s[6])))
                            courseFrequency[int.Parse(s[6])] += 1;
                        else
                            courseFrequency.Add(int.Parse(s[6]), 1);
                    }
                }
                catch (Exception e)
                {
